...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.UID<'product_name'>;
    ...
    publishedAt: Schema.Attribute.DateTime;
    sizes: Schema.Attribute.Relation<'manyToMany', 'api::size.size'>;
    surface_types: Schema.Attribute.Relation<
      'manyToMany',
      'api::surface-type.surface-type'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSurfaceTypeSurfaceType extends Struct.CollectionTypeSchema {
  collectionName: 'surface_types';
  info: {
    displayName: 'Surface-Type';
    pluralName: 'surface-types';
    singularName: 'surface-type';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    products: Schema.Attribute.Relation<'manyToMany', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    surface_name: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
